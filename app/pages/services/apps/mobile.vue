  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.apps.sub.mobile') }}</h1>
...
import { mobileCalculatorConfig as calcConfig } from '~/config/mobileCalculator'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.apps.sub.mobile') }
])

const content = computed(() => {
  const c = get('servicesTree.apps.mobileContent')
  return c && typeof c === 'object' ? c : null
})

const comparison = computed(() => {
  const data = get('servicesTree.apps.mobileComparison')
...
const calcLabels = computed(() => get('servicesTree.apps.mobileCalculator') || {})
...
const pageTitle = computed(() => t('servicesTree.apps.sub.mobile'))
