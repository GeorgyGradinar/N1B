  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.apps.sub.crm') }}</h1>
...
const detailKey = 'servicesTree.apps.subDetail.crm'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.apps.sub.crm') }
])
const pageTitle = computed(() => t('servicesTree.apps.sub.crm'))
