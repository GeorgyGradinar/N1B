  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.apps.sub.api') }}</h1>
...
const detailKey = 'servicesTree.apps.subDetail.api'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.apps.sub.api') }
])
const pageTitle = computed(() => t('servicesTree.apps.sub.api'))
