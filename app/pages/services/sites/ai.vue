  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.sites.sub.ai') }}</h1>
...
const detailKey = 'servicesTree.sites.subDetail.ai'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.sites.sub.ai') }
])
const pageTitle = computed(() => t('servicesTree.sites.sub.ai'))
