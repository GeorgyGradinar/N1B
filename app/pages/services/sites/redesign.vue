  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.sites.sub.redesign') }}</h1>
...
import { redesignCalculatorConfig as calcConfig } from '~/config/redesignCalculator'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.sites.sub.redesign') }
])

const content = computed(() => {
  const c = get('servicesTree.sites.redesignContent')
