  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.recruitment.sub.devops') }}</h1>
...
const detailKey = 'servicesTree.recruitment.subDetail.devops'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.recruitment.sub.devops') }
])
const pageTitle = computed(() => t('servicesTree.recruitment.sub.devops'))
