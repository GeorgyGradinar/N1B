  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.recruitment.sub.outstaff') }}</h1>
...
const detailKey = 'servicesTree.recruitment.subDetail.outstaff'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.recruitment.sub.outstaff') }
])
const pageTitle = computed(() => t('servicesTree.recruitment.sub.outstaff'))
