  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <p class="article-category">{{ t('servicesTree.recruitment.title') }}</p>
        <h1 class="article-title">{{ t('servicesTree.recruitment.sub.assessment') }}</h1>
...
const detailKey = 'servicesTree.recruitment.subDetail.assessment'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.recruitment.title') },
  { label: t('servicesTree.recruitment.sub.assessment') }
])
const pageTitle = computed(() => t('servicesTree.recruitment.sub.assessment'))
