  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.recruitment.sub.project') }}</h1>
...
const detailKey = 'servicesTree.recruitment.subDetail.project'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.recruitment.sub.project') }
])
const pageTitle = computed(() => t('servicesTree.recruitment.sub.project'))
