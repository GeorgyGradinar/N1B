  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.optimization.sub.automation') }}</h1>
...
const detailKey = 'servicesTree.optimization.subDetail.automation'
const detail = computed(() => { const v = t(detailKey); return v !== detailKey ? v : '' })
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.optimization.sub.automation') }
])
const pageTitle = computed(() => t('servicesTree.optimization.sub.automation'))
