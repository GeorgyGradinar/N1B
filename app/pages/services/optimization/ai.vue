  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.optimization.sub.ai') }}</h1>
...
const detailKey = 'servicesTree.optimization.subDetail.ai'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.optimization.sub.ai') }
])
const pageTitle = computed(() => t('servicesTree.optimization.sub.ai'))
