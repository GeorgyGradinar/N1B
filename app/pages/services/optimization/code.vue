  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.optimization.sub.code') }}</h1>
...
const detailKey = 'servicesTree.optimization.subDetail.code'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.optimization.sub.code') }
])
const pageTitle = computed(() => t('servicesTree.optimization.sub.code'))
