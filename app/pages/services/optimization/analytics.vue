  ...
  <div class="page">
    <div class="page-inner section">
      ...
      <article class="article">
        ...
        <h1 class="article-title">{{ t('servicesTree.optimization.sub.analytics') }}</h1>
...
const detailKey = 'servicesTree.optimization.subDetail.analytics'
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('servicesTree.optimization.sub.analytics') }
])
const pageTitle = computed(() => t('servicesTree.optimization.sub.analytics'))
